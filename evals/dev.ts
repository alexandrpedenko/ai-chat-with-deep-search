export const devData = [
  {
    ...
    expected: "The current TypeScript version is 5.6.3 as of October 2025",
  },
  {
...
Development and Build Performance: Improved build times and Faster Fast Refresh.`,
  ...
  {
    input: "Compare the performance differences between React 18 and React 19",
    expected: "React 19 introduces automatic batching improvements, better concurrent rendering performance, and the React Compiler for automatic optimizations. Key performance gains include reduced re-renders through improved scheduling and better memory management.",
  },
];